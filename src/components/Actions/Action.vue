<template>
  <div class="relative w-full overflow-hidden rounded-md shadow">
    ...
    <div class="flex flex-row justify-start items-center gap-1 py-2.5 px-3 absolute bottom-0 right-0 left-0 z-10 bg-content shadow-[0_-2px_8px_0_rgba(0,0,0,0.1)]">
